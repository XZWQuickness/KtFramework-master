package com.xzw.framelibrary.utils
...
import com.xzw.framelibrary.app.MyApplication
import com.xzw.framelibrary.observer.SmsContentObserver
...
object xzwUtils {
    ...
    class MyHandler constructor(internal var mContext: Context, private var textView: TextView,private var length:Int) : Handler() {
        ...
        override fun handleMessage(msg: Message) {
            ...
            textView.text = xzwUtils.patternCode(outbox, length)
        }
    }
