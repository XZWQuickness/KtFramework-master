package com.xzw.framelibrary.view.pwd.adapter;
...
public class KeyBoardAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.pwd_grid_item_virtual_keyboard, null);
        ...
        if (position == 9) {
            ...
            viewHolder.btnKey.setBackgroundResource(R.mipmap.pwd_keyboard_delete_img);
