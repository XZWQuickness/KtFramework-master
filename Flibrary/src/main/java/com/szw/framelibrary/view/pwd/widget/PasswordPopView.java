package com.xzw.framelibrary.view.pwd.widget;
...
import com.xzw.framelibrary.view.pwd.adapter.KeyBoardAdapter;
...
public class PasswordPopView extends RelativeLayout {
    ...
    public PasswordPopView(Context context) {
        this(context, null);
    }

    public PasswordPopView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;

        View view = View.inflate(context, R.layout.pwd_layout_popup_bottom, null);
        ...
        price = (TextView) view.findViewById(R.id.textAmount);
    ...
    public TextView getViewForgetPwd() {
        return tv_forgetPwd;
    }
}
